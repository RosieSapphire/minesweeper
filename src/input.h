...
#define INPUT_R_PREV    (1u << INPUT_R_PREV_SHIFT)
#define INPUT_R_CURR    (1u << INPUT_R_CURR_SHIFT)
#define INPUT_R_PRESS   (1u << INPUT_R_PRESS_SHIFT)
#define INPUT_R_RELEASE (1u << INPUT_R_RELEASE_SHIFT)

#define INPUT_MASK_PREV (INPUT_LMB_PREV | INPUT_RMB_PREV | INPUT_R_PREV)
#define INPUT_MASK_CURR (INPUT_LMB_CURR | INPUT_RMB_CURR | INPUT_R_CURR)
