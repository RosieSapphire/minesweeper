 ...
 *  @ingroup window
 */
typedef void (*GLFWframebuffersizefun)(GLFWwindow *window,
                                       int         width,
                                       int         height);
 ...
 *  @ingroup window
 */
typedef void (*GLFWwindowcontentscalefun)(GLFWwindow *window,
                                          float       xscale,
                                          float       yscale);
 ...
 *  @ingroup input
 */
typedef void (*GLFWmousebuttonfun)(GLFWwindow *window,
                                   int         button,
                                   int         action,
                                   int         mods);
 ...
 *  @ingroup input
 */
typedef void (*GLFWcursorposfun)(GLFWwindow *window,
                                 double      xpos,
                                 double      ypos);
 ...
 *  @ingroup input
 */
typedef void (*GLFWscrollfun)(GLFWwindow *window,
                              double      xoffset,
                              double      yoffset);
 ...
 *  @ingroup input
 */
typedef void (*GLFWkeyfun)(GLFWwindow *window,
                           int         key,
                           int         scancode,
                           int         action,
                           int         mods);
 ...
 *  @ingroup input
 */
typedef void (*GLFWcharmodsfun)(GLFWwindow  *window,
 ...
 *  @ingroup input
 */
typedef void (*GLFWdropfun)(GLFWwindow *window,
                            int         path_count,
                            const char *paths[]);
